/***********************************************************  
* Change script to upgrade LibBill database from 2.0.6 to 2.0.7
***********************************************************/
...
***********************************************************/
declare
  required_version application_setting.setting_value%type := '2.0.6';
begin
...
/***********************************************************  
*
* WS-676: Allow LibBill invoices to have multiple item codes
*
***********************************************************/
