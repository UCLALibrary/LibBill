...
hashURL=hashURL & "branches/delete_service/service/" & strID 
...
postURL=postURL & "branches/delete_service/service/" & strID 
...
if xmlhttp.status = 200 then
  response.write "<p class=GenericMessage>Service deleted:</p>"
else
