<%
  ...
  strAmount=request("txtInvoiceAmount")



hashURL=session("strBaseHash")
hashURL=hashURL & "invoices/invoice_by_total/" & strAmount
...
strSig=strIDKey & ":" & strHash
    ...
    getInvoiceURL=getInvoiceURL & "invoices/invoice_by_total/" & strAmount
...
XMLDOC.LOAD(xmlhttp.responsebody)
  ...
  if oNodeList.length=0 then
    ...
    %>
    <p>Invoices with total of $<%=strAmount%></p>
    <p><table>
    <tr>
