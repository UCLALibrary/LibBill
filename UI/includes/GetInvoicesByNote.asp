...
hashURL=hashURL & "invoices/invoice_by_inv_note/" & strNote
...
strSig=strIDKey & ":" & strHash
    ...
    getInvoiceURL=getInvoiceURL & "invoices/invoice_by_inv_note/" & strNote
...
XMLDOC.LOAD(xmlhttp.responsebody)
  ...
  if oNodeList.length=0 then
    response.write "<p class=ErrorMessage>No matching invoices on file..."
  else
    ...
    %>
    <p>Invoices with invoice note text: <%=strInvoiceNote%></p>
    <p><table>
    <tr>
