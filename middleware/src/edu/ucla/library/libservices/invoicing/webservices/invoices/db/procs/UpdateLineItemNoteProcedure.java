...
public class UpdateLineItemNoteProcedure
  extends StoredProcedure
{
  ...
  public UpdateLineItemNoteProcedure( JdbcTemplate jdbcTemplate,
                                      String string )
  {
    super( jdbcTemplate, string );
  }

  public UpdateLineItemNoteProcedure( DataSource dataSource,
                                      String string )
  {
    super( dataSource, string );
  }

  public UpdateLineItemNoteProcedure()
  {
    super();
  }
  ...
  private void prepProc()
  {
    setDataSource( ds );
    setFunction( false );
    //setSql( "invoice_owner.update_line_item_note" );
    setSql( "update_line_item_note" );
